      ...
      <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="header">MAIN NAVIGATION</li>
                ...
                <li class="<?php echo ($this->uri->uri_string() == 'user' || $this->uri->uri_string() == 'user/tambah' || $this->uri->segment(1) == 'user' && $this->uri->segment(2) == 'edit' && $this->uri->segment(3) != '') ? 'active' : '';?>">
            ...
            <li class="treeview">
            <a href="#">
            <?php $this->data['idbo'] = $this->session->userdata('ses_id'); ?>
