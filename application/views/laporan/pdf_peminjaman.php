...
$table2 = '<table border="1" width="650px">';
  $table2 .= '<tr style="background-color: lightblue;">
              ...
              foreach($laporan as $row){
                ...
                <td style="text-align: center; font-family: sans-serif; font-size: 12px;">'. $row->user .'</td>
                <td style="text-align: center; font-family: sans-serif; font-size: 12px;">'. $row->title .'</td>
