                    ...
                    <table id="example1" class="table table-bordered table-striped table" width="100%">
                        ...
                        <?php $no=1;foreach($buku->result_array() as $isi){?>
                            <tr>
                                ...
                                <td><?= $isi['tgl_masuk'];?></td>
									<td <?php if($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'Petugas'){?>style="width:17%;"<?php }?>>
									...
									<?php }else{?>
										<a href="transaksi/pinjam">
										<button class="btn btn-danger"><i class="fa fa-book"></i> Pinjam</button></a>
                                        <a href="<?= base_url('data/bukudetail/'.$isi['id_buku']);?>">
										<button class="btn btn-primary"><i class="fa fa-sign-in"></i> Detail</button></a>
									<?php }?>
                                </td>
